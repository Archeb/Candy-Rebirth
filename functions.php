            ...
            <div class="comment-container">
                ...
                <div class="comment-author-info">
                    <div class="comment-meta">
                        ...
                        <a class="comment-time"><?php echo time_elapsed_string('@'.strtotime($comments->date->format('Y-m-d H:i'))) ?>前<span class="detail-time">&nbsp;·&nbsp;<?php echo $comments->date->format('Y-m-d H:i'); ?></span></a>
                    </div>
